...
\begin{document}
	...
	$S^{-1}R$ gerade der Quotioentenkörper von $R$, falls $S=R\setminus\{0\}$ ist. Betrachten wir also beispielweise den Ring 
	...
	$S=\setZ\{0\}$ an, dann sind die $\setZ\setminus\{0\}^{-1}\setZ$- also $\setQ$-Moduln 
	$\setZ\setminus\{0\}^{-1}(\setR /\pi\setZ)$ und 
	$\setZ\setminus\{0\}^{-1}\setR /\setZ\setminus\{0\}^{-1}\pi\setZ$ 
	isomorph. Wir bemerken, dass $\setZ\setminus\{0\}^{-1}\setR=\setR$ und 
	$\setZ\setminus\{0\}^{-1}\pi\setZ=\pi\setQ$. Damit gilt also 
	\[ \setZ\setminus\{0\}^{-1}(\setR /\pi\setZ)\cong \setR/\pi\setQ.\]
	
	Es lässt sich nun folgendes Resultat zeigen, siehe dazu auch 
	...
	dann
	\begin{align*}
		S^{-1}R=\setQ,\qquad S^{-1}M=\setR
		\quad\text{ und }\quad S^{-1}N=\setR /\pi\setQ.
	\end{align*}
	Weiterhin gilt
	\[S^{-1}(M\otimes_R N)\cong \setR/\pi\setQ,\]
	...
	\begin{align*}
		...
		\left.\left\langle \left\{\frac{r\otimes s}{z}\right\vert
		 r\in\setR,s\in\setR/\pi\setZ,s\in\setZ\setminus\{0\}^{-1}\right\}\right\rangle \\
		 &\simeq \left.\left\langle \left\{\frac{r}{z}\otimes s\right\vert r\in\setR,s\in\setR/\pi\setZ,s\in\setZ\setminus\{0\}^{-1}\right\}
		 \right\rangle \\
	...
	\[\setR\otimes_\setZ\setR/\pi\setZ\simeq\setR\otimes_\setQ\setR/\pi\setQ.\]
