...
\begin{document}
	...
	\begin{proof}
		...
		$f$, sd. gilt $f(P)=Q$. Dann gilt mit der Linearität von $f$ also
		\[f(\lambda P)=\{f(\lambda p)\ \vert\ p\in P\} =\{\lambda f(p)\ \vert\ p\in P\}=\lambda f(P)=\lambda Q.\]
		Damit sind also $\lambda P$ und $\lambda Q$ kongruent. \\
		Seien also für die Rückrichtung nun $\lambda P\cong \lambda Q$, also 
		gibt es eine Isometrie $f$, sd. $f(\lambda P)=\lambda Q$. Dann 
		gilt mit der Dilatation $\frac{1}{\lambda}$, dass
		\[f(P)=1\cdot f(P)=\frac{1}{\lambda}\lambda f(P)=\frac{1}{\lambda} f(\lambda P)=\frac{1}{\lambda} \lambda Q =1\cdot Q=Q.\]
