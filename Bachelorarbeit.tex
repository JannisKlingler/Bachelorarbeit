...
\begin{document}
	...
	\begin{remark}\label{bem:mink;zerl}
		...
		Betrachten wir die Zerlegungen der einzelnen Polytope und 
		die von $P\times Q$ in $R\times S$. So ergeben sich, 
		durch Ausmultiplizieren mit den Distributivgesetzen der Minkowski-Addition, 
		Zerlegungen, dessen einzelne Polytope mit Bemerkung 
