...
\begin{document}
	...
	\end{definition}
	 ...
	 Operation und der Identitätsabbildung als neutralem Element. Wir wollen 
	...
	$P$ zerlegungsgleich ist und das in $Q$ enthalten ist. Wir schreiben 
	\[P\sim_{\subset} Q\]
	hierfür.
	...
	\begin{proof}
		...
		\begin{itemize}
			...
			definieren durch
			\[\lambda=\left(\frac{\gamma}{2}\right)(n^{d-i}-1)^{1/d}\]
			...
			\[n^i\cdot P\sim_{\subset}n^i \cdot \lambda W.\]
			...
			\begin{align}
				vol(Q_0)-vol(P_0)=(vol(Q)-vol(P))(n^d -n^i)=\gamma^d(n^d-n^i). \label{lemma:teilzerl;1}
			\end{align}
		\end{itemize}
	\end{proof}
