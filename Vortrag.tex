...
\begin{document}
	...
	Wir werden im Folgenden immer beschränkte konvexe $d$-Polytope betrachten.
	...
	Im Folgenden meinen wir mit $P_1+\ldots+P_n$ die bis auf $(d-1)$-Facetten disjunkte Vereinigung. Wobei 
	...
	\begin{proof}
		Klar, da Isometrien abstandserhaltende Funktionen sind.
	\end{proof}
	...
	\begin{proposition} \label{prop:zerl,vol}
		Seien $P$ und $Q$ zerlegungsgleiche Polyeder, dann gilt $vol(P)=vol(Q)$.
	\end{proposition}
	
	\begin{proof}
		Seien $P=P_1+\ldots+P_n$ und $Q=Q_1+\ldots+Q_n$ die Zerlegungen von $P$ und 
		$Q$, also $P_i\cong Q_i$ für alle $i=1,\ldots,n$. Dann gilt mit Proposition \ref{prop:cong,vol}
