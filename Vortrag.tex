...
\begin{document}
	...
	\begin{definition}[Polytop]
		Ein $d$-Polytop $P$ in einem $d$-dimensionalen reellen Vektorraum $V$ ist der Schnitt endlich vieler 
	...
	\begin{figure}[!htbp]
		\centering
		\includegraphics[scale=1.8]{DreieckLemma}
	...
	\begin{proof}
		...
		\end{align}
		Seien $o,a,b,c$ die Eckpunkte des Dreiecks $P$ und $o,m,n,p$ die Eckpunkte des Dreiecks $Q$. Wir 
		verschieben hier $Q$ so auf auf $P$, dass beide eine gemeinsame Ecke $o$ mit rechtem Winkel haben. 
	...
	$\setR \otimes_{\setZ} \setR / 2\pi\setZ$ betrachen. Hierbei identifizieren wir die Länge einer Kante mit dem 
	...
	\begin{example}[regulärer Tetraeder] \label{exp:regTetr}
		...
		den gleichen Diederwinkel $\alpha$. Seien $A,B,C,D$ die Ecken von $P$ wie in Abbildung \ref{Abb.2}. 
